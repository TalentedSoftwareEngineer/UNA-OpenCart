...
<div class="d-flex align-items-center">
    <button onclick="onMoveBusinessAnalytics(event)" class="btn btn-outline-primary btn-block" role="button">Business Analytics</button>
</div>
...
<script type="text/javascript">
    ...
    function onMoveBusinessAnalytics(event) {
        debugger;
    }
</script>
