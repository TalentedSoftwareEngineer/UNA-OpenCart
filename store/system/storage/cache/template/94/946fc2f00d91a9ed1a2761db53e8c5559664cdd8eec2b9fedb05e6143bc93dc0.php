...
class __TwigTemplate_5565c8c025dfc70be773c07beebf8bfaffe75307d88b42bb0e137566952fb77a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\$('select[name=\\'country_id\\']').on('change', function () {
      ...
      \$('#toggle_store_type').change(function() {
        if(this.checked) {
          \$('#store_type_label').text('Physical store');
          alert('To authorized as Physical store then send a email to contact@salescouch.com');
        } else {
          \$('#store_type_label').text('Virtual store');
        }
