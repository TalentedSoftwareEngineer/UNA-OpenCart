...
class __TwigTemplate_734b4dcbd2aadb0e8211b1b3b2401dcee0da7e2d1572a467cb9630a3a1402543 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
  ...
  <div class=\"container-fluid\">
    ...
    ";
      ...
      <div class=\"col-md-9 col-md-pull-3 col-sm-12\">
        ...
        // line 163
        echo twig_get_attribute($this->env, $this->source, ($context["JSON"] ?? null), "stringify", [0 => ($context["table_sub_products"] ?? null)], "method", false, false, false, 163);
        echo "\" id=\"input-table_sub_products\" />
            </form>
          </div>
        </div>
        ...
        if (($context["table_sub_products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "                        </td>
                        <td class=\"text-right\">";
                // line 222
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 222) <= 0)) {
                    echo " <span class=\"label label-warning\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 222);
                    echo "</span> ";
                } elseif ((twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 222) <= 5)) {
  ...
  <script type=\"text/javascript\"><!--
    var addedSubProducts = \$('#input-table_sub_products').val();
    debugger;
