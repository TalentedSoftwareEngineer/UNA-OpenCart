...
class __TwigTemplate_01b920f2f9852527d325d299b9cb2fe9dd6d2c8c226c3be3a46eec6d6354a52a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
      ...
      <div class=\"col-md-9 col-md-pull-3 col-sm-12\">
        ...
        if (($context["all_products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "', '";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "image", [], "any", false, false, false, 172);
                echo "', '";
                ...
                echo "', '";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 172);
                echo "', '";
  ...
  <script type=\"text/javascript\"><!--
    ...
    function onClickSearchProductItem(event, product_id, image, name, model, price, special, quantity, status) {
      
      addedSubProducts.push(product_id);
      \$('#input-sub_products').val(String(addedSubProducts));
      
      addSubProductTr({product_id, image, name, model, price, special, quantity, status});
    ...
    function addSubProductTr(product) {
      var html = `<tr>
                    <td class=\"text-center\">";
        // line 275
        if (twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "image", [], "any", false, false, false, 275)) {
            echo " <img src=\"";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "image", [], "any", false, false, false, 275);
            echo "\" alt=\"";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 275);
            echo "\" class=\"img-thumbnail\" /> ";
        } else {
            echo " <span class=\"img-thumbnail list\"><i class=\"fa fa-camera fa-2x\"></i></span> ";
        }
        echo "</td>
                    <td class=\"text-left\">";
        // line 276
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 276);
        echo "</td>
                    <td class=\"text-left\">";
        // line 277
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "model", [], "any", false, false, false, 277);
        echo "</td>
                    <td class=\"text-right\">
                      ";
        // line 279
        if (twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 279)) {
            echo " <span style=\"text-decoration: line-through;\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 279);
            echo "</span><br />
                      <div class=\"text-danger\" data-toggle=\"popover\" title=\"";
            // line 280
            echo ($context["text_calculator"] ?? null);
            ...
            echo ($context["text_getway_charge"] ?? null);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 280);
            echo "</div>
                      ";
        } else {
            // line 282
            ...
            echo ($context["text_getway_charge"] ?? null);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 282);
            echo "</div>
                      ";
        }
        // line 284
        echo "                    </td>
                    <td class=\"text-right\">";
        // line 285
        if ((twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 285) <= 0)) {
            echo " <span class=\"label label-warning\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 285);
            echo "</span> ";
        } elseif ((twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 285) <= 5)) {
            echo " <span class=\"label label-danger\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 285);
            echo "</span> ";
        } else {
        ...
        echo "</td>
                    <td class=\"text-left\"><kbd>";
        // line 286
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "status", [], "any", false, false, false, 286);
        echo "</kbd></td>
                    <td class=\"text-right\">
                      <button data-toggle=\"tooltip\" title=\"";
        // line 288
      ...
      \$('#sub_products_tbody').append(html);
    }
...
";
    ...
    {
        return array (  740 => 296,  729 => 288,  724 => 286,  708 => 285,  705 => 284,  693 => 282,  682 => 280,  676 => 279,  671 => 277,  667 => 276,  655 => 275,  596 => 218,  590 => 215,  587 => 214,  584 => 213,  574 => 209,  569 => 207,  553 => 206,  550 => 205,  538 => 203,  527 => 201,  521 => 200,  516 => 198,  512 => 197,  500 => 196,  497 => 195,  492 => 194,  490 => 193,  483 => 189,  465 => 188,  447 => 187,  429 => 186,  411 => 185,  393 => 184,  389 => 183,  380 => 176,  377 => 175,  351 => 172,  347 => 170,  340 => 168,  336 => 167,  333 => 166,  328 => 165,  326 => 164,  313 => 154,  303 => 147,  297 => 144,  291 => 143,  286 => 141,  277 => 137,  272 => 135,  263 => 131,  258 => 129,  253 => 126,  247 => 124,  245 => 123,  239 => 122,  234 => 120,  229 => 117,  223 => 115,  221 => 114,  215 => 113,  210 => 111,  205 => 109,  199 => 106,  191 => 100,  183 => 92,  176 => 88,  169 => 84,  158 => 78,  149 => 72,  143 => 68,  135 => 64,  133 => 63,  127 => 59,  116 => 57,  112 => 56,  107 => 54,  101 => 53,  97 => 52,  93 => 51,  84 => 46,  37 => 1,);
    }
