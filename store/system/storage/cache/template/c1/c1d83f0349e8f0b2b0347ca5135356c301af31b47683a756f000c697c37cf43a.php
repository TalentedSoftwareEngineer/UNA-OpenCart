...
class __TwigTemplate_28e158986ecb4ee75a2177b24f98cb924a5cf3d24cc543b14eaab1fa146c59fd extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <script type=\"text/javascript\"><!--
    ...
    function addSubProductTr(product) {
      ...
      html += Boolean(product.special) 
              ? '<span style=\"text-decoration: line-through;\">' + product.price + '</span><br/><div class=\"text-danger\" data-toggle=\"popover\" title=\"";
        // line 285
        echo ($context["text_calculator"] ?? null);
        echo "\" data-content=\"";
        echo ($context["text_admin_commission"] ?? null);
        ...
        echo ($context["text_getway_charge"] ?? null);
        echo "\">";
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 285);
        echo "</div>';
