...
class __TwigTemplate_e9479f95844e2e0baff5dd8245821cafc7de9bfcfc390c0dd6020e06c4a057c2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\$('select[name=\\'country_id\\']').on('change', function () {
      ...
      \$.ajax({
        ...
        success: function(response){
          console.log(Boolean(Number(response.store_type)));
        },
