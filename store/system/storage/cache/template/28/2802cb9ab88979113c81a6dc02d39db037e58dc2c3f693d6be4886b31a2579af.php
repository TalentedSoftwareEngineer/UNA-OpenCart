...
class __TwigTemplate_7f81fe3ea9867b722df4fc29a0a6f3a76ec51b68cd9483505748e0855a3f35aa extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\$('select[name=\\'country_id\\']').on('change', function () {
      ...
      \$('#toggle_store_type').change(function() {
        if(this.checked) {
          \$('#store_type_label').text('Physical store');
          \$('#message').html('<a href=\"#\">To authorized as Physical store & enjoy full ecommerce advance benefits click here</a>');
        } else {
          \$('#store_type_label').text('Virtual store');
          \$('#message').text('');
        }
