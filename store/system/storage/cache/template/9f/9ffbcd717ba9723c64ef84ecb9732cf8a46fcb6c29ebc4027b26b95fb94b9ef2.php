...
class __TwigTemplate_28bd2a5ae70b225bab8facdc6fa6269ce5df419e44056876d032745db02fce00 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
  ...
  <script type=\"text/javascript\"><!--
    ...
    function addSubProductTr(product) {
      ...
      html += '</td>';
      html += '<td class=\"text-right\">';
      html += '<input onchange=\"onChangeSubQuantity()\" id=\"sub_quantity-' + product.product_id + '\" class=\"sub-quantity\" type=\"number\" value=\"' + product.quantity + '\" />';
      html += '</td>';
