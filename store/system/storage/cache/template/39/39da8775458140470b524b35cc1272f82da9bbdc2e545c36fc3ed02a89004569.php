...
class __TwigTemplate_2e297315dbcabc2f9dd577fe797b0bcce3c8e301324b5e946809854b0e2e3084 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <script type=\"text/javascript\"><!--
    ...
    function onAddSubProduct(event, product_id, image, name, model, price, special, quantity, status) {
      if(addedSubProducts.findIndex(function (item){return item.product_id == product_id})==-1) {
        ...
        \$('#input-sub_products').val(JSON.stringify(addedSubProducts.map(function(item){return item.product_id})));
      }
