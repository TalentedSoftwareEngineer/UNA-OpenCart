...
class __TwigTemplate_ceb9cdff463bfd46bcd7f62132a9587d7c08f146993da7616ef96b4a32a99b9b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\$('select[name=\\'country_id\\']').on('change', function () {
      ...
      \$('#toggle_store_type').change(function() {
        if(this.checked) {
          \$('#store_type_label').text('Physical store');
          \$('#message').html('<a href=\"store/index.php?route=account/vendor/lts_store\">To authorized as Physical store & enjoy full ecommerce advance benefits click here</a>');
        } else {
          \$('#store_type_label').text('Virtual store');
          \$('#message').text('');
        }
