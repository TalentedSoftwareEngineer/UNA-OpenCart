...
class __TwigTemplate_964872aae21206e2e84eb6eee756459c24ead57f01cf39fe320d19382ead4609 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
  ...
  <script type=\"text/javascript\"><!--
    ...
    function addSubProductTr(product) {
      ...
      html += '</td>';
      html += '<td class=\"text-right\">';
      html += '<input onchange=\"onChangeSubQuantity()\" id=\"sub_quantity-' + product.product_id + '\" data-product-id = \"' + product.product_id + '\" class=\"sub-quantity\" type=\"number\" value=\"' + product.quantity + '\" />';
      html += '</td>';
