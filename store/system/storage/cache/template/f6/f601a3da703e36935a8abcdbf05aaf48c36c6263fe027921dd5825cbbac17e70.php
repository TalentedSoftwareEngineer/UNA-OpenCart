...
class __TwigTemplate_7246c89c1ebedcf96a82f98729f7a4655a808f126f88c71353662b623ed0b568 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  #productsList li:hover:not(.header) {
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "                        </td>
                        <td class=\"text-right\">";
                // line 205
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 205) <= 0)) {
                    echo " <span class=\"label label-warning\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 205);
                    echo "</span> ";
                } elseif ((twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 205) <= 5)) {
                ...
                // line 206
                echo twig_get_attribute($this->env, $this->source, $context["product"], "status", [], "any", false, false, false, 206);
                echo "</kbd></td>
                        <td class=\"text-right\">
