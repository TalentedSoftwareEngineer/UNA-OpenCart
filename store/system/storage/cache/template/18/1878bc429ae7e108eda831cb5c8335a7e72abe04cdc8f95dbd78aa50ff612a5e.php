...
class __TwigTemplate_c12cc5fcc082d82f1d913a8c0130ff34f6aa02277c1a81ea9aa6308650965796 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
<nav id=\"column-left\">
  <div id=\"navigation\"><span id=\"menu_title_icon\"></span><span id=\"menu_title\" style=\"margin-left: 10px;\"></span></div>
  <ul id=\"menu\">
    ";
        // line 5
        $context["i"] = 0;
    ...
    \$.ajax({
      ...
      success: function(response){
        if(Boolean(Number(response.store_type))) {
          ...
          \$('#menu_title_icon').addClass('fa fa-shopping-cart');
        } else {
          \$('#menu_title').text('Virtual store owner');
          \$('#menu_title_icon').addClass('fa fa-tv');
        }
      },
