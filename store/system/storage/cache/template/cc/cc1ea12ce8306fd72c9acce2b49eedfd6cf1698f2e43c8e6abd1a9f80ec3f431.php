...
class __TwigTemplate_971a1742d48f8c9954d973d94b07cad130e74ad6354d38d2dfe339b498664734 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid\">
      ...
      ";
        ...
        echo "</td>
                                    <td class=\"text-right\">";
        // line 68
        if ((($context["sort"] ?? null) == "p.total_sellers")) {
            echo " <a href=\"";
            echo ($context["sort_total_sellers"] ?? null);
            echo "\" class=\"";
            echo twig_lower_filter($this->env, ($context["order"] ?? null));
            echo "\">";
            echo ($context["column_total_sellers"] ?? null);
            echo "</a> ";
        } else {
            echo " <a href=\"";
            echo ($context["sort_total_sellers"] ?? null);
        ...
        echo "</td>
                                    <td class=\"text-right\">";
        // line 69
        if ((($context["sort"] ?? null) == "p.sold_quality")) {
            echo " <a href=\"";
            echo ($context["sort_sold_quality"] ?? null);
            echo "\" class=\"";
            echo twig_lower_filter($this->env, ($context["order"] ?? null));
            echo "\">";
            echo ($context["column_sold_quality"] ?? null);
            echo "</a> ";
        } else {
            echo " <a href=\"";
            echo ($context["sort_sold_quality"] ?? null);
