...
class __TwigTemplate_4825ea2b8a9a8a71d9437b3dfbd044582252166f0edae48e240239ed66128987 extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            echo "\">
                  ...
                  <div class=\"form-group\">
                    ...
                    <div class=\"col-sm-10 d-flex align-items-center\">
                      <label class=\"switch\">
                        <input id=\"toggle_store_type\" type=\"checkbox\" checked>
                        <span class=\"slider round\"></span>
                      </label>
                      <strong id=\"store_type_label\" style=\"margin-left: 10px;\">Physical store owner</strong>
                    </div>
                  </div>
...
\$('select[name=\\'country_id\\']').on('change', function () {
      ...
      \$('#toggle_store_type').change(function() {
        if(this.checked) {
          \$('#store_type_label').text('Virtual store owner');
        } else {
          \$('#store_type_label').text('Physical store owner');
        }
      });
