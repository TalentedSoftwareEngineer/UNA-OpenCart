...
class __TwigTemplate_fb5f882ff8c1e32675430b5cd1b060ef918b3189d00759c3059e55ba51988127 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <script type=\"text/javascript\"><!--
    ...
    function addSubProductTr(product) {
      ...
      var html = `<tr>
                    <td class=\"text-center\">";
        // line 276
        if (twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "image", [], "any", false, false, false, 276)) {
            echo " <img src=\"";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "image", [], "any", false, false, false, 276);
            echo "\" alt=\"";
        ...
        echo "</td>
                    <td class=\"text-left\">";
        // line 277
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 277);
        echo "</td>
                    <td class=\"text-left\">";
        // line 278
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "model", [], "any", false, false, false, 278);
        echo "</td>
                    <td class=\"text-right\">
                      ";
        // line 280
        if (twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 280)) {
            echo " <span style=\"text-decoration: line-through;\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 280);
            echo "</span><br />
                      <div class=\"text-danger\" data-toggle=\"popover\" title=\"";
            // line 281
            echo ($context["text_calculator"] ?? null);
            ...
            echo ($context["text_getway_charge"] ?? null);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 281);
            echo "</div>
                      ";
        } else {
            // line 283
            ...
            echo ($context["text_getway_charge"] ?? null);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 283);
            echo "</div>
                      ";
        }
        // line 285
        echo "                    </td>
                    <td class=\"text-right\">";
        // line 286
        if ((twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 286) <= 0)) {
            echo " <span class=\"label label-warning\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 286);
            echo "</span> ";
        } elseif ((twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 286) <= 5)) {
            echo " <span class=\"label label-danger\">";
            echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 286);
            echo "</span> ";
        } else {
        ...
        echo "</td>
                    <td class=\"text-left\"><kbd>";
        // line 287
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "status", [], "any", false, false, false, 287);
        echo "</kbd></td>
                    <td class=\"text-right\">
                      <button data-toggle=\"tooltip\" title=\"";
        // line 289
