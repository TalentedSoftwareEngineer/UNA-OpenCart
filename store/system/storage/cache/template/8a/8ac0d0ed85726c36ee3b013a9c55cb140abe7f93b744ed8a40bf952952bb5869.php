...
class __TwigTemplate_9b2155336b55fd76d82370c15a67d43fda194303098d645551de4e3028a538ff extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"col-md-9 col-md-pull-3 col-sm-12\">
        ...
        if (($context["table_sub_products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                // line 220
                echo "                        </td>
                        <td class=\"text-right\"><input type=\"number\" value=\"";
                // line 221
  ...
  <script type=\"text/javascript\"><!--
    ...
    function addSubProductTr(product) {
      ...
      html += '<input type=\"number\" value=\"";
        // line 319
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "quantity", [], "any", false, false, false, 319);
        echo "\" />';
      html += '</td>';
