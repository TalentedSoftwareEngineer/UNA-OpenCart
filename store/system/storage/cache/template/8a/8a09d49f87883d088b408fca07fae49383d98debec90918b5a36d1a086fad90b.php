...
class __TwigTemplate_bed179fcd20ff8a391ceb7bbb4b8021e7cf707745ff236880d27258e7bf276fe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
      ...
      <div class=\"col-md-9 col-md-pull-3 col-sm-12\">
        ...
        if (($context["table_sub_products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                // line 220
                echo "                        </td>
                        <td class=\"text-right\"><input id=\"sub_quantity-";
                // line 221
  ...
  <script type=\"text/javascript\"><!--
    ...
    \$('.sub-quantity').on('change', function() {
    ...
    function addSubProductTr(product) {
      ...
      html += '</td>';
      html += '<td class=\"text-right\">';
      html += '<input  id=\"sub_quantity-' + product.product_id + '\" data-product-id = \"' + product.product_id + '\" class=\"sub-quantity\" type=\"number\" value=\"' + product.quantity + '\" />';
      html += '</td>';
