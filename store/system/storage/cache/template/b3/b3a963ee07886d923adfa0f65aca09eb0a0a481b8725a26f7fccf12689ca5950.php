...
class __TwigTemplate_b956d60910142e9dea1c32a104ad588f86ed037905ce5aec673676d64fd05815 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\$('select[name=\\'country_id\\']').on('change', function () {
      ...
      \$('#toggle_store_type').change(function() {
        if(this.checked) {
          \$('#store_type_label').text('Physical store');
          \$('#message').text('To authorized as Physical store & enjoy full ecommerce advance benefits click here');
        } else {
          \$('#store_type_label').text('Virtual store');
          \$('#message').text('');
        }
