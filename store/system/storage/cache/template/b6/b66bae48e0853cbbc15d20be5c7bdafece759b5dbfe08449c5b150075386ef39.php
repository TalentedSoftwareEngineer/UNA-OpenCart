...
class __TwigTemplate_4a0147cbe06e9f3e30dcfb14e1456bfb3aeeb019ba20a45a70d4d8b89c0784eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
  ...
  <script type=\"text/javascript\"><!--
    ...
    function addSubProductTr(product) {
      ...
      html += '</td>';
      html += '<td class=\"text-right\">';
      html += '<input data-product-id = \"' + product.product_id + '\" class=\"sub-quantity\" type=\"number\" value=\"' + product.quantity + '\" />';
      html += '</td>';
