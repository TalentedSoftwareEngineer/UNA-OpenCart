	...
	public function index() {
		...
		foreach($vendors as $vendor) {
			...
			$data['vendors'][] = array(
				...
				'description'	=>utf8_substr(strip_tags(html_entity_decode($vendor['description'], ENT_QUOTES, 'UTF-8')), 0, $this->config->get('theme_' . $this->config->get('config_theme') . '_product_description_length')) . '..',			
