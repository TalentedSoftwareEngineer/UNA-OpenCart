...
class ControllerAccountVendorLtsManufacturer extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server["REQUEST_METHOD"] == "POST") && $this->validateForm()) {
      ...
      $this->response->redirect($this->url->link("account/vendor/lts_manufacturer", '', true));
    }
  ...
  protected function getList() {
    ...
    $data["breadcrumbs"][] = array(
        ...
        "href" => $this->url->link("account/vendor/lts_manufacturer", $url, true)
    );

    $data["add"] = $this->url->link("account/vendor/lts_manufacturer/add", '', true);
    $data["delete"] = $this->url->link("account/vendor/lts_manufacturer/delete", '', true);
    ...
    foreach ($results as $result) {
      $data["manufacturers"][] = array(
          ...
          "edit" => $this->url->link("account/vendor/lts_manufacturer/edit", "&manufacturer_id=" . $result["manufacturer_id"], true)
      );
    }
    ...
    $data["sort_name"] = $this->url->link("account/vendor/lts_manufacturer", "&sort=name" . $url, true);
    $data["sort_sort_order"] = $this->url->link("account/vendor/lts_manufacturer", "&sort=sort_order" . $url, true);
  ...
  protected function getForm() {
    ...
    if (!isset($this->request->get["manufacturer_id"])) {
      $data["action"] = $this->url->link("account/vendor/lts_manufacturer/add", $url, true);
    } else {
      $data["action"] = $this->url->link("account/vendor/lts_manufacturer/edit", "&manufacturer_id=" . $this->request->get["manufacturer_id"] . $url, true);
    }

    $data["cancel"] = $this->url->link("account/vendor/lts_manufacturer", $url, true);
...
// print_r($this->request->get["filter_name"]); die;
      $results = $this->model_account_vendor_lts_manufacturer->getManufacturers($filter_data);
