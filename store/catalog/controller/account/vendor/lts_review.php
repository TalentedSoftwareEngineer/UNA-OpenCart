...
class ControllerAccountVendorLtsReview extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) { 
     ...
     $this->model_account_vendor_lts_review->addReview($this->request->post['product_id'], $this->request->post, $vendor_info);
  ...
  public function autocomplete() {
    ...
    if (isset($this->request->get['filter_name'])) {
      ...
      $results = $this->model_account_vendor_lts_review->getVendorProduct($filter_data);
  ...
  public function autherautocompelete() {
