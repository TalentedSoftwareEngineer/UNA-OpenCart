...
class ControllerAccountVendorLtsOrder extends Controller {
  ...
  public function index() {
    ...
    if (!$this->customer->isLogged()) {
        $this->session->data['redirect'] = $this->url->link('account/vendor/lts_dashboard', '', true);
  ...
  $this->load->controller('account/vendor/lts_header/script');
   ...
   if(!$vendor_info) {
    ...
    $data['sort_order'] = $this->url->link('account/vendor/lts_order', '&sort=o.order_id' . $url, true);
    $data['sort_customer'] = $this->url->link('account/vendor/lts_order', '&sort=customer' . $url, true);
    $data['sort_status'] = $this->url->link('account/vendor/lts_order', '&sort=order_status' . $url, true);
    $data['sort_total'] = $this->url->link('account/vendor/lts_order', '&sort=o.total' . $url, true);
    $data['sort_date_added'] = $this->url->link('account/vendor/lts_order', '&sort=o.date_added' . $url, true);
    $data['sort_date_modified'] = $this->url->link('account/vendor/lts_order', '&sort=o.date_modified' . $url, true);
  ...
  public function createInvoiceNo() {
    ...
    if (!$this->user->hasPermission('modify', 'account/vendor/lts_order')) {
  ...
  public function invoice() {
    ...
    foreach ($orders as $order_id) {
      ...
      if ($order_info) {
        ...
        $products = $this->model_account_vendor_lts_order->getOrderProducts($order_id, $vendor_info['vendor_id']);
        ...
        foreach ($products as $product) {
          ...
          if ($product_info) {
            ...
            foreach ($options as $option) {
              ...
              $product_option_value_info = $this->model_account_vendor_lts_product->getProductOptionValue($product['product_id'], $option['product_option_value_id']);

              // print_r($product_option_value_info); die;
    // echo "jjjj"; die;
