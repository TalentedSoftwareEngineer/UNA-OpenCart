...
class ControllerAccountVendorLtsFilter extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server["REQUEST_METHOD"] == "POST") && $this->validateForm()) {
      ...
      $this->response->redirect($this->url->link("account/vendor/lts_filter", '', true));
    }
  ...
  protected function getList() {
    ...
    $data["add"] = $this->url->link("account/vendor/lts_filter/add", '', true);
    $data["delete"] = $this->url->link("account/vendor/lts_filter/delete", '', true);
  ...
  protected function getForm() {
    ...
    if (!isset($this->request->get["filter_group_id"])) {
      $data["action"] = $this->url->link("account/vendor/lts_filter/add", '', true);
    } else {
      $data["action"] = $this->url->link("account/vendor/lts_filter/edit", "&filter_group_id=" . $this->request->get["filter_group_id"] . $url, true);
    }

    $data["cancel"] = $this->url->link("account/vendor/lts_filter", '', true);
