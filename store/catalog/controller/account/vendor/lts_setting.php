...
class ControllerAccountVendorLtsSetting extends controller {
  ...
  protected function validate() {
    ...
    if ((utf8_strlen($this->request->post['ifsc']) < 3)  || (utf8_strlen($this->request->post['ifsc']) > 10)) {
      $this->error['ifsc'] = $this->language->get(' ');
    }
    
    if(!ctype_alnum($this->request->post['ifsc']))
    {
      $this->error['ifsc'] = $this->language->get(' ');
    }
