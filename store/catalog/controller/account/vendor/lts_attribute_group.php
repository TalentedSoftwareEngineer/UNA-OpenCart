...
class ControllerAccountVendorLtsAttributeGroup extends Controller {
  ...
  public function add() {
   ...
   if(!$vendor_info) {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      ...
      $this->response->redirect($this->url->link('account/vendor/lts_attribute_group', '', true));
    }
  ...
  protected function getList() {
    ...
    $data['add'] = $this->url->link('account/vendor/lts_attribute_group/add', '', true);
    $data['delete'] = $this->url->link('account/vendor/lts_attribute_group/delete', '', true);
  ...
  protected function getForm() {
    ...
    if (!isset($this->request->get['attribute_group_id'])) {
      $data['action'] = $this->url->link('account/vendor/lts_attribute_group/add', $url, true);
    } else {
    ...
    $data['cancel'] = $this->url->link('account/vendor/lts_attribute_group', '', true);
  ...
  protected function validateDelete() {
    ...
    foreach ($this->request->post['selected'] as $attribute_group_id) {
      ...
      $attribute_total = $this->model_account_vendor_lts_attribute->getTotalAttributesByAttributeGroupId($attribute_group_id);
