...
class ControllerAccountVendorLtsProduct extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      ...
      $this->response->redirect($this->url->link('account/vendor/lts_product', '', true));
    }
    $this->getForm();
  }
  ...
  protected function getList() {
    ...
    if($can_add_multi_product){
        $data['add'] = $this->url->link('account/vendor/lts_product/add', '', true);
        $data['copy'] = $this->url->link('account/vendor/lts_product/copy', '', true);
        $data['add_enabled'] = 1;
    }else{
       if($products==0){
        $data['add'] = $this->url->link('account/vendor/lts_product/add', '', true);
    ...
    $data['delete'] = $this->url->link('account/vendor/lts_product/delete', '', true);
    ...
    $data['sort_name'] = $this->url->link('account/vendor/lts_product',"&sort=pd.name" . $url, true);
    $data['sort_model'] = $this->url->link('account/vendor/lts_product',"&sort=p.model" . $url, true);
    $data['sort_price'] = $this->url->link('account/vendor/lts_product',"&sort=p.price" . $url, true);
    $data['sort_quantity'] = $this->url->link('account/vendor/lts_product',"&sort=p.quantity" . $url, true);
    $data['sort_status'] = $this->url->link('account/vendor/lts_product',"&sort=p.status" . $url, true);
  ...
  public function edit() {
   ...
   $this->load->controller('account/vendor/lts_header/script');
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
     ...
     $product_exist=$this->model_account_vendor_lts_product->editProduct($this->request->get['product_id'], $vendor_info['vendor_id'],  $this->request->post);     
     // if($product_exist==0)
     //  {
     //  $this->session->data['error_success'] = $this->language->get('error_product_exist');  
     //  }
  ...
  protected function getForm() {
    ...
    if (!isset($this->request->get['product_id'])) {
      $data['action'] = $this->url->link('account/vendor/lts_product/add', '', true);
    } else {
...
// print_r($product_info); die;
    $data['cancel'] = $this->url->link('account/vendor/lts_product', '', true);
  ...
  // print_r($product_info['manufacturer_id']);
    ...
    //   $pincode = $this->request->post['pincode_checker'];
    // } elseif (isset($this->request->get['product_id'])) {

    // $pincodes['pincode_checkers'] = $this->model_account_vendor_lts_product->getProductPincode($this->request->get['product_id']);       
  ...
  foreach ($product_options as $product_option) {
      ...
      if (isset($product_option['product_option_value'])) {
        foreach ($product_option['product_option_value'] as $product_option_value) {
            ...
            $product_option_value_data[] = array(
                'product_option_value_id' => isset($product_option_value['product_option_value_id'])?$product_option_value['product_option_value_id']:0,
                'option_value_id' => isset($product_option_value['option_value_id'])?$product_option_value['option_value_id']:0,
                'quantity' => isset($product_option_value['quantity'])?$product_option_value['quantity']:0,
                'subtract' => isset($product_option_value['subtract'])?$product_option_value['subtract']:0,
                'price' => isset($product_option_value['price'])?$product_option_value['price']:0,
                ...
                'weight' => isset($product_option_value['weight'])?$product_option_value['weight']:0,
    ...
    foreach ($product_images as $product_image) {
      ...
      if(isset($this->request->get['product_id']))
      {
        $data['exist_product_id']=$this->request->get['product_id'];
      }
    ...
    $data['lts_language_id']=$this->config->get('language_id');
    $this->load->controller('account/vendor/lts_header/script');
    $data['footer'] = $this->load->controller('account/vendor/lts_footer');
    $data['header'] = $this->load->controller('account/vendor/lts_header');
    $data['lts_column_left'] = $this->load->controller('account/vendor/lts_column_left');
  ...
  protected function validateForm() {
    ...
    // if ($total >= $plan_info['no_of_product'] && $plan_info['no_of_product']>0) {
  ...
  public function autocomplete() {
    ...
    if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
      ...
      $results = $this->model_account_vendor_lts_product->getAllProducts($filter_data);
...
public function getProductInfo()
{
 ...
 $this->load->model("account/vendor/lts_product");
 $result=$this->model_account_vendor_lts_product->getProductInfo($product_id);  
