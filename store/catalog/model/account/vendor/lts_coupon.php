...
class ModelAccountVendorLtsCoupon extends Model {
	...
	public function getCoupons($data = array()) {
		$sql = "SELECT c.coupon_id as coupon_id, c.date_start as date_start, c.date_end as date_end, c.name as name, c.code as code, c.discount as discount, c.status as status FROM " . DB_PREFIX . "coupon c JOIN ". DB_PREFIX ."lts_coupon lc ON(c.coupon_id = lc.coupon_id) ";
		...
		if (!empty($data['filter_price'])) {
			$sql .= " AND c.discount LIKE '" . $this->db->escape($data['filter_price']) . "%'";
		}
		...
		if (isset($data['filter_date_end']) && $data['filter_date_end'] !== '') {
			$sql .= " AND c.date_end = '" . $data['filter_date_end'] . "'";
