...
class ModelAccountVendorLtsAttributeGroup extends Model {
	...
	public function getTotalAttributeGroups($data = array()) {
		...
		public function getTotalAttributeGroups_id($group_id) {
			echo $group_id; die;
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "lts_attribute_group WHERE attribute_group_id = '" . (int)$group_id . "'");
