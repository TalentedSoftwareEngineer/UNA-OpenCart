...
class ModelCatalogProduct extends Model {
 ...
 $result = $this->db->query("SELECT * FROM " . DB_PREFIX . "product WHERE product_id = '" . (int) $product_id . "'")->row;
                
                if(isset($result))          
                {               
                $this->db->query("UPDATE " . DB_PREFIX . "lts_product SET quantity ='".$result['quantity']."', price='".$result['price']."', status='".$result['status']."'  WHERE product_id = '" . (int)$product_id . "'");     
                }
