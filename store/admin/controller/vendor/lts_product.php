...
class ControllerVendorLtsProduct extends Controller {
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            ...
            $data['products'][] = array(
                ...
                'edit'          => $this->url->link('vendor/lts_product/edit', 'user_token=' . $this->session->data['user_token'] . '&product_id='.$result['product_id'].$url, true),
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('vendor/lts_product', 'user_token=' . $this->session->data['user_token'] . $url, true));
        }
    ...
    protected function getForm() {          
        ...
        if (!isset($this->request->get['product_id'])) {
            $data['action'] = $this->url->link('vendor/lts_product', 'user_token=' . $this->session->data['user_token'] .$url, true);
        } else {
        $a=ltrim($this->request->get['product_id'], '.');
        $data['action'] = $this->url->link('vendor/lts_product/edit', 'user_token=' . $this->session->data['user_token'].'&product_id='.$a, true);
        }

        $data['cancel'] = $this->url->link('vendor/lts_product', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        if (isset($this->request->post['product_recurrings'])) {
            ...
            $data['product_recurrings'] = $this->model_vendor_lts_product->getRecurrings($this->request->get['product_id']);
        } else {
        ...
        if(isset($this->request->get['product_id']))
        {
             $product_id=ltrim($this->request->get['product_id']);
             $data['vendorInfo']=$this->model_vendor_lts_product->getVendorInfo($product_id);
