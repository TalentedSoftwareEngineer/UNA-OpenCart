...
class ModelVendorLtsAttribute extends Model {
	...
	public function editAttributeMapping($attribute_mapping_id, $data) {
		...
		$this->db->query("UPDATE ". DB_PREFIX ."lts_attribute_mapping SET attribute='". $attributes ."', category_id='". (int)$data['category_id'] ."' WHERE attribute_mapping_id='". (int)$attribute_mapping_id ."'");
	}
