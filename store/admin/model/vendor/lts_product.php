...
class ModelVendorLtsProduct extends Model {
    ...
    public function getVendorInfo($product_id)
    {
        ...
        $result = $this->db->query("SELECT * FROM " . DB_PREFIX . "lts_vendor lv WHERE lv.vendor_id = (SELECT vendor_id FROM " . DB_PREFIX . "lts_product WHERE product_id = '" . (int)$product_id . "')");
        return $result->row;
