<div id="<?php echo $a['html_id'];?>" class="<?php echo $a['style_prefix'];?>-views">
    <div id="<?php echo $a['html_id_content'];?>" class="<?php echo $a['style_prefix'];?>-v-cnt">
        <?php echo $a['content'];?>
        <div id="<?php echo $a['html_id_view_placeholder'];?>" class="<?php echo $a['style_prefix'];?>-view <?php echo $a['style_prefix'];?>-view-holder bx-def-bc-margin" style="display:none">
            <div class="flex-1 mb-4 ring-1 ring-gray-200 dark:ring-gray-700 bg-white dark:bg-gray-800 rounded-md">
